...
func (g *GroupChat) AddMember(
	...
	if g.deleted {
		return mo.Err[GroupChatWithEventPair](NewGroupChatAddMemberErr("The group chat is deleted"))
	}
	if g.members.IsMember(&userAccountId) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatAddMemberErr("The userAccountId is already the member of the group chat"))
	}
	if !g.members.IsAdministrator(&executorId) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatAddMemberErr("The executorId is not the administrator of the group chat"))
	}
...
func (g *GroupChat) RemoveMemberByUserAccountId(userAccountId models.UserAccountId, executorId models.UserAccountId) mo.Result[GroupChatWithEventPair] {
	if g.deleted {
		return mo.Err[GroupChatWithEventPair](NewGroupChatRemoveMemberErr("The group chat is deleted"))
	}
	if !g.members.IsMember(&userAccountId) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatRemoveMemberErr("The userAccountId is not the member of the group chat"))
	}
	if !g.members.IsAdministrator(&executorId) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatRemoveMemberErr("The executorId is not the administrator of the group chat"))
	}
...
func (g *GroupChat) Rename(name models.GroupChatName, executorId models.UserAccountId) mo.Result[GroupChatWithEventPair] {
	...
	if !g.members.IsAdministrator(&executorId) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatAddMemberErr("The executorId is not an administrator of the group chat"))
	}
	if g.name.Equals(&name) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatAddMemberErr("The name is already the same as the current name"))
	}
...
func (g *GroupChat) Delete(executorId models.UserAccountId) mo.Result[GroupChatWithEventPair] {
	if g.deleted {
		return mo.Err[GroupChatWithEventPair](NewGroupChatDeleteErr("The group chat is deleted"))
	}
	if !g.members.IsAdministrator(&executorId) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatDeleteErr("The executorId is not the member of the group chat"))
	}
...
func (g *GroupChat) PostMessage(message models.Message, executorId models.UserAccountId) mo.Result[GroupChatWithEventPair] {
	if g.deleted {
		return mo.Err[GroupChatWithEventPair](NewGroupChatPostMessageErr("The group chat is deleted"))
	}
	if !g.members.IsMember(message.GetSenderId()) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatPostMessageErr("The senderId is not the member of the group chat"))
	}
	if !g.members.IsMember(&executorId) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatPostMessageErr("The executorId is not the member of the group chat"))
	}
	if !message.GetSenderId().Equals(&executorId) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatPostMessageErr("The executorId is not the senderId of the message"))
	}
	newMessages, exists := g.messages.Add(message).Get()
	if !exists {
		return mo.Err[GroupChatWithEventPair](NewGroupChatPostMessageErr("The message is already posted"))
	}
...
func (g *GroupChat) DeleteMessage(messageId models.MessageId, executorId models.UserAccountId) mo.Result[GroupChatWithEventPair] {
	if g.deleted {
		return mo.Err[GroupChatWithEventPair](NewGroupChatDeleteMessageErr("The group chat is deleted"))
	}
	if !g.members.IsMember(&executorId) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatPostMessageErr("The executorId is not the member of the group chat"))
	}
	...
	if !exists {
		return mo.Err[GroupChatWithEventPair](NewGroupChatDeleteMessageErr("The message is not found"))
	}
	member := g.members.FindByUserAccountId(message.GetSenderId()).MustGet()
	if !member.GetUserAccountId().Equals(&executorId) {
		return mo.Err[GroupChatWithEventPair](NewGroupChatDeleteMessageErr("The executorId is not the sender of the message"))
	}
